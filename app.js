...
const menuLinks = document.querySelectorAll(".nav-links a, .mobile-menu a");
...
function initAnimations() {
    ...
    gsap.utils.toArray("section").forEach((sec) => {
        gsap.from(sec.querySelectorAll("h2, p, li, .project-card, .skills-list li"), {
            scrollTrigger: {
                trigger: sec,
